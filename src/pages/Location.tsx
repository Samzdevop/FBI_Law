...
const locations = [
  ...
  },
  {
    ...
    // phone: "310.793.6598",
    // fax: "562.684.0378",
    description: `Based upon client demand, ASP Law Group, Inc. also services employers in northern and southern California in defense of workers compensation and civil litigation. We are able to successfully implement our unique approach to case handling within the legal and business environment in California. Notably, we use multifaceted metrics that are specific to California and partner with employers to not only handle legal matters but also serve as consultants in advising employers in a competitive business market. We look forward in becoming your legal partners!`,
  },
];
