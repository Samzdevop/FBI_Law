...
export const featuredPartner = {
  ...
  image:
   lawyerImg, 
  quote:
    "FBI Legal was founded on the principles of strategic excellence and unwavering commitment to our clients' success in a dynamic global environment.",
  bio: `Femi B. Ishola is the founding and Managing Partner of FBI Legal.
  With extensive experience advising corporations, investors and institutions,
  he has built a reputation for delivering strategic legal solutions that
  drive business growth and mitigate risk.`,
};
